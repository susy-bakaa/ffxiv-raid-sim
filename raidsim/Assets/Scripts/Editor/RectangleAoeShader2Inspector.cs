...
{
    public class RectangleAoeShader2Inspector : ShaderGUI
    {
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            // Find properties
            MaterialProperty outerWidthProp = FindProperty("_OuterWidth", properties);
            MaterialProperty outerHeightProp = FindProperty("_OuterHeight", properties);
            MaterialProperty innerSizeProp = FindProperty("_InnerSize", properties);
            ...
            MaterialProperty lineSizeProp = FindProperty("_LineSize", properties);
            ...
            outerWidthProp.floatValue = Mathf.Max(outerWidthProp.floatValue, 0);
            outerHeightProp.floatValue = Mathf.Max(outerHeightProp.floatValue, 0);
            innerSizeProp.floatValue = Mathf.Clamp01(innerSizeProp.floatValue);
            ...
            lineSizeProp.floatValue = Mathf.Max(lineSizeProp.floatValue, 0);
            ...
            outerWidthProp.floatValue = EditorGUILayout.FloatField("Outer Width", outerWidthProp.floatValue);
            outerHeightProp.floatValue = EditorGUILayout.FloatField("Outer Height", outerHeightProp.floatValue);
            innerSizeProp.floatValue = EditorGUILayout.Slider("Inner Size", innerSizeProp.floatValue, innerSizeProp.rangeLimits.x, innerSizeProp.rangeLimits.y);
            ...
            lineSizeProp.floatValue = EditorGUILayout.FloatField("Sweep Size", lineSizeProp.floatValue);
