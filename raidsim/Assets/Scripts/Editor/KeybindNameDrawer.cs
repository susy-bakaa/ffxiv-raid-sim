...
{
    [CustomPropertyDrawer(typeof(KeybindNameAttribute))]
    public class KeybindNameDrawer : PropertyDrawer
    {
        string[] _cachedNames;
        ...
        public override void OnGUI(Rect pos, SerializedProperty prop, GUIContent label)
        {
            ...
            var attr = (KeybindNameAttribute)attribute;
            ...
            if (_cachedNames == null || EditorApplication.timeSinceStartup - _lastRefreshTime > 2.0)
            {
                ...
                _cachedNames = LoadKeybindNamesFromPrefab(path);
            }
            ...
            if (_cachedNames == null || _cachedNames.Length == 0)
            {
                ...
                EditorGUI.HelpBox(
                    ...
                    $"No keybinds found in prefab at:\n{path}",
                    MessageType.Warning
                );
                return;
            }
        ...
        private string[] LoadKeybindNamesFromPrefab(string assetPath)
        {
            ...
            var mgr = go.GetComponent<UserInput>();
            if (mgr == null || mgr.keys == null)
                return new string[0];
            ...
            names.AddRange(mgr.keys.Where(ib => !string.IsNullOrEmpty(ib.name)).Select(s => s.name));
