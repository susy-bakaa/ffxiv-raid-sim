...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class GamepadIconsExample : MonoBehaviour
    {
        ...
        public GamepadIcons nintendoSwitchPro;
        ...
        protected void OnUpdateBindingDisplay(RebindActionUI component, string bindingDisplayString, string deviceLayoutName, string controlPath)
        {
            ...
            if (InputSystem.IsFirstLayoutBasedOnSecond(deviceLayoutName, "DualShock4GamepadHID"))
                icon = ps4.GetSprite(controlPath);
            else if (InputSystem.IsFirstLayoutBasedOnSecond(deviceLayoutName, "DualSenseGamepadHID"))
                icon = ps5.GetSprite(controlPath);
            else if (InputSystem.IsFirstLayoutBasedOnSecond(deviceLayoutName, "SwitchProControllerHID"))
                icon = nintendoSwitchPro.GetSprite(controlPath);
